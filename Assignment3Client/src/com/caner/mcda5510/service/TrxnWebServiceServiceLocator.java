...
public class TrxnWebServiceServiceLocator extends org.apache.axis.client.Service implements com.caner.mcda5510.service.TrxnWebServiceService {
    ...
    public com.caner.mcda5510.service.TrxnWebService getTrxnWebService() throws javax.xml.rpc.ServiceException {
    ...
    public com.caner.mcda5510.service.TrxnWebService getTrxnWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.caner.mcda5510.service.TrxnWebServiceSoapBindingStub _stub = new com.caner.mcda5510.service.TrxnWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.caner.mcda5510.service.TrxnWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.caner.mcda5510.service.TrxnWebServiceSoapBindingStub _stub = new com.caner.mcda5510.service.TrxnWebServiceSoapBindingStub(new java.net.URL(TrxnWebService_address), this);
                _stub.setPortName(getTrxnWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.mcda5510.caner.com", "TrxnWebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.mcda5510.caner.com", "TrxnWebService"));
        }
