...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        public ContactGenerator()
        {
            ...
            String outputFileName = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\customers.csv";
        ...
        {
            String firstNames = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\firstNames.txt";
            return ReturnRandomLine(firstNames);
        }

        public string GenerateLastName()
        {
            String lastNames = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\lastNames.txt";
        ...
        {
            String streetNumber = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\streetNumber.txt";
            return ReturnRandomLine(streetNumber);
        }

        public string GenerateStreet()
        {
            String street = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\street.txt";
            return ReturnRandomLine(street);
        }

        public string GenerateCity()
        {
            String city = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\city.txt";
            return ReturnRandomLine(city);
        }

        public string GenerateProvince()
        {
            String province = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\province.txt";
            return ReturnRandomLine(province);
        }

        public string GenerateCountry()
        {
            String country = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\country.txt";
            return ReturnRandomLine(country);
        }

        public string GeneratePostalCode()
        {
            String postal = @"C:\Users\Caner\Desktop\A00425840\MCDA5510_AssignmentsC\ConsoleApp1\ConsoleApp1\postalCode.txt";
